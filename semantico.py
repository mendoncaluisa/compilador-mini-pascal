...
class Semantico:
    def __init__(self, sintatico):
        ...
        # a partir daqui a gente vai criar o Semantico. ELe e o Sintatico
        # são muito amarrados entao a gente nao vai criar um objeto pro semantico
    ...
    # no metodo gera, nivel é o nivel de identação. Cada nível é igual a 4
    # espaços. Nivel 0: 0 espaços, Nivel 1: 4 espaços
